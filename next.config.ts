...
const contentSecurityPolicy = [
  ...
  "img-src 'self' data: blob: https://icons.brapi.dev https://s.yimg.com https://financialmodelingprep.com https://cdn.pluggy.ai https://api.qrserver.com https://*.basemaps.cartocdn.com",
  "font-src 'self' data:",
