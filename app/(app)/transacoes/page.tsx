...
export default async function TransactionsPage({ searchParams }: { searchParams: Promise<{ year?: string; month?: string }> }) {
  ...
  return <div className="space-y-7"><PageHeader title="Transações" description="Aqui você pode visualizar todas suas transações" actions={<MonthNavigator year={year} month={month} compact />} /><TransactionsClient data={data} /></div>;
}
